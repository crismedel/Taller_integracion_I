...
<body>
    ...
    <header class="header" id="inicio">
        ...
        <nav class="menu-navegacion">
            ...
            <a href="Soporte.php"><lord-icon src="https://cdn.lordicon.com/hursldrn.json" trigger="loop" delay="500" colors="primary:#5fffff,secondary:#FF00FF" stroke="30"style="width:32px;height:32px"></lord-icon>Sugerencias</a> 
